  ...
  return (
    <div id='membresia' className='md:mt-52'>
        <div className='container mx-auto px-6'>
            ...
            <p className='text-xl text-center font-ProductSansRegular px-8 mt-5 text-[#52525B]'>Elegí la opción que más se adapte a vos y obtené increibles beneficios</p>
        </div>

        <div className='container mx-auto flex max-sm:grid md:gap-20 justify-center pt-8 pb-20 max-sm:p-4'>

            <div className='bg-white w-auto h-auto border border-black rounded-xl mt-10 py-8 sombra2'>

                <div className='w-full px-8 mt-8'>
                  <div>
                    <h3 className='text-4xl max-sm:text-3xl text-center font-ProductSansBold mt-5 py-2'>
                        Plan Mensual
                    </h3>
                    <h2 className='text-[#F07167] text-center text-4xl max-sm:text-3xl font-ProductSansBold py-2'>
                    $4.500
                    </h2>
                  </div>
            ...
            <div className='bg-white w-auto h-auto border border-black rounded-xl mt-10 py-8 sombra2'>
                ...
                <div className='w-full  px-8 mt-8'>
                  <div>
                    ...
                    <h2 className='text-[#00AFB9] text-center text-4xl max-sm:text-3xl font-ProductSansBold py-2'>
                      $10.000
                    </h2>
                  </div>
