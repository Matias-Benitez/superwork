  ...
  return (
    <>
        ...
        <div className='w-1/2 mt-24 py-4 flex justify-center px-8 max-sm:hidden'>
            <img src="https://i.postimg.cc/52p5PfGc/superwork-recursos.png" alt="Recursos exclusivos" />
        </div>
        ...
        <div className='w-1/2 md:mt-24 py-4 flex justify-center px-8 max-sm:w-full'>
            <img src="https://i.postimg.cc/Tw5rYgPG/superwork-conexiones.png" alt="Conexiones en Superwork" />
        </div>
        </div>
    </>
  )
