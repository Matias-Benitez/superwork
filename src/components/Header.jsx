  ...
  return (
    <header className="flex items-center justify-between xl:justify-start w-full py-4 px-8 h-[10vh] z-50">
      ...
      <nav
        ...
        <a onClick={() => setShowMenu(!showMenu)} href="#membresia" className="hover:bg-[#FFC28A] hover:text-black font-ProductSansRegular rounded-xl transition-all bg-[#1A1A1A] text-[#FDFCDC] py-3 px-5 ">
          Ser miembro
        </a>
      </nav>
      <button
